...
exports.handler = async (event, context) => {
  const { pageSize = 4 * 6, startAfter } = event.queryStringParameters;

  // Create base query ordered by date descending
  let query = db.collection('projects').orderBy('dateCreated', 'desc');
