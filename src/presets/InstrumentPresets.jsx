...
const setSynthParam = (property, min, max) =>
  (shape, val) => {
    shape.synth.set(property, Utils.convertValToRange(val, 0, 100, min, max));
  };

const setSynthEnvelopeParam = (property, min, max) =>
  (shape, val) => {
    shape.synth.envelope.set(property, Utils.convertValToRange(val, 0, 100, min, max));
  };
    ...
    dynamicParams: [
      {
        ...
        target: 'instrument',
        func: (shape, val) => {
          shape.synth.voice0.envelope.set('attack', Utils.convertValToRange(val, 0, 100, 1, 0));
        }
      }, 
      {
        name: 'attack',
        ...
        target: 'instrument',
        func: (shape, val) => {
          shape.synth.voice1.oscillator.set('detune', Utils.convertValToRange(val, 0, 100, 0, 20));
          shape.synth.voice0.oscillator.set('detune', Utils.convertValToRange(val/100, 0, 100, 0, 20));
        }
      }, 
      {
        name: 'fuzz',
